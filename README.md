...
- 雙方收結交接
- 產生每日總覽與背景索引
- 正式交接前檢查共同目標、雙方任務邊界、交接點、行動項、證據與風險
- 舊項目升級
...
你不用事前寫好完整 brief。這句話只是觸發 AI 開始問診。

AI 應該先建立一張交接定義卡，確認 Jay 是否已是這個項目的協作對象、她在今次任務中是接手執行、審閱還是補資料、共同目標是甚麼、你這邊已完成甚麼、請 Jay 做哪一至三件事、她不應做甚麼、證據在哪裡，以及還有甚麼風險。

如果資料不足，AI 應該最多問幾條關鍵問題來補洞，而不是直接發正式交接包。

補齊後，AI 才整理交接內容，列出目標、現況、請對方做的事、證據位置與風險。它會先讓你確認，確認後才寫入共用 Drive 資料夾。
...
如果 AI 未能判斷共同目標、對方角色、請對方做的事或證據位置，它應該停下來問你，不應發正式 APS 交接包。
