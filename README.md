...
| 項目 | 目前狀態 |
|---|---|
| 本頁對應版本 | `@adamchanadam/aps@0.2.38` |
| 對應 GitHub release 標籤 | `v0.2.38` |
...
不是。本頁對應的 `@adamchanadam/aps@0.2.38` 是可用於受控實際試行的前期測試版，不應承諾為不可中斷、不可出錯的生產級工具。
